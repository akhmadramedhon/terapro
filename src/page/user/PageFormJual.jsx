...
export const sertifikatOptions = [
  { key: "SHM", label: "Sertifikat Hak Milik (SHM)" },
  { key: "SHGB", label: "Sertifikat Hak Guna Bangunan (SHGB)" },
  { key: "SHP", label: "Sertifikat Hak Pakai (SHP)" },
  { key: "SHGU", label: "Sertifikat Hak Guna Usaha (SHGU)" },
  { key: "HPL", label: "Sertifikat Hak Pengelolaan (HPL)" },
  { key: "SHMSRS", label: "Sertifikat Hak Milik Satuan Rumah Susun (SHMSRS)" },
  { key: "Girik", label: "Girik" },
];
      ...
      <Card>
        ...
        <CardBody>
          <form onSubmit={handleSubmit} className="space-y-4">
            <Select
              items={sertifikatOptions}
              label="Jenis Sertifikat"
              placeholder="Pilih jenis sertifikat"
              onChange={(key) => {
                // Memanggil handler orang tua (jika perlu simpan di formData)
                const event = {
                  target: {
                    name: "sertifikat",
                    value: key,
            ...
            <Input label="Nomor Hak" name="nomorDesa" onChange={handleChange} required />
            ...
            <Input label="Nomor Dasar Pendaftaran / Penerbitan" name="dasarPenerbitan" onChange={handleChange} required />
